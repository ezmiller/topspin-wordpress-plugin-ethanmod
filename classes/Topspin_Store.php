 ...
 *      2011-09-29
		...
		- updated getStores function to return also the navmenu_position of the stores
...
EOD;
	...
	public function createStore($post,$page_id) {
		...
		$this->wpdb->insert($this->wpdb->prefix.'topspin_stores',$data,array('%d','%s','%d','%d','%d','%s','%s','%s','%d','%d'));
